// GENERATED AUTOMATICALLY FROM 'Assets/_Project/Functionallity/Input/InputMaster.inputactions'
...
public class InputMaster : IInputActionCollection
{
    ...
    public struct PinballMachineActions
    {
        ...
        public PinballMachineActions(InputMaster wrapper) { m_Wrapper = wrapper; }
